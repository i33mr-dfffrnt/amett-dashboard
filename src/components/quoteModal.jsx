...
export default function QuoteModal(props) {
  ...
  const submitQuote = async () => {
    ...
    if (validateForm()) {
      try {
        await amettAPI.post(`/quotes`, {
          name: fullName,
          email,
          message,
          modelName: props.selectedModel.name,
          modelId: props.selectedModel._id,
        });
        setIsLoading(false);
  ...
  return (
    <Transition.Root show={props.quoteModalState} as={Fragment}>
      <Dialog
        as="div"
                  ...
                  <div className="sm:flex sm:items-start px-4  pb-4  sm:pb-4">
                    ...
                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                      ...
                      <div className="mt-2">
                        ...
                        <input
                          className="border border-gray-200 bg-gray-300 h-10 px-2  rounded-lg text-sm focus:outline-none  w-48 sm:w-72 "
                          name="model"
                          type="text"
                          value={props.selectedModel.name}
                          disabled
                        />
                        <label
                          for="message"
